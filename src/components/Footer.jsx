...
const Footer = () => {
  ...
  return (
    <footer>
      ...
      <a className="footer-link" href="https://github.com/solimanghandour">
        <span>
          <AiOutlineStar /> {gitHubInfo.stars} <BiGitRepoForked />
          {gitHubInfo.forks} - Give this project a star!
        </span>
        <p>
          <span>▷</span> Designed and built by Soliman Ghandour &copy; {currentYear}
        </p>
      ...
      <motion.a
        href="https://www.buymeacoffee.com/soliman_ghandour"
        initial="initial"
        whileHover="hover"
        whileTap="tap"
