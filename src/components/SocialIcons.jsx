...
const SocialIcons = () => {
  ...
  return (
    <div className="socialIcons" style={styles.socialIcons}>
      <a className="icon" style={styles.icon} href="https://github.com/solimanghandour">
        {/* GitHub Icon */}
        <motion.i
      ...
      <a className="icon" style={styles.icon} href="https://www.linkedin.com/in/soliman-ghandour-b13aa7260/">
        {/* LinkedIn Icon */}
        <motion.i
      ...
      <a className="icon" style={styles.icon} href="https://www.instagram.com/soliymohamed/">
        {/* Instagram Icon */}
        <motion.i
          initial={{ y: 100, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
      ...
      <a className="icon" style={styles.icon} href="https://twitter.com/Soliman32557284">
        {/* Twitter Icon */}
        <motion.i
          initial={{ y: 100, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
